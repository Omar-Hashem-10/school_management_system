            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a
                            href="{{ route('dashboard.admin.certificates.index') }}">Certificates</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card m-3 p-3 shadow-lg">
                    <div class="card-headedr border-transparent">
                        <h4>Student: {{ $certificate->student->user->first_name . ' ' .
                            $certificate->student->user->last_name }}</h4>
