      ...
      <div class="col-lg-12">
        <div class="card">
          <div class="card-header border-transparent">
            <a href="{{ route('dashboard.student.contact.create') }}" class="btn btn-sm btn-info float-left">Add
              Contact</a>
          </div>
          <div class="card-header border-transparent">
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="btn-group" role="group">
                      <form class="d-inline" action="{{route('dashboard.student.contact.destroy',$contact->id)}}"
                        method="post">
                        @csrf
                        @method('delete')
