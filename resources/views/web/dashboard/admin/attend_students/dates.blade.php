              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a class="btn btn-primary d-inline" href="{{route('dashboard.admin.attend_students.index',[$date->id,$classRoom])}}">View</a>
                    <div class="btn-group" role="group">
                      <form class="d-inline" action="{{route('dashboard.admin.dates.destroy',$date->id)}}" method="post">
                        @csrf
                        @method('delete')
