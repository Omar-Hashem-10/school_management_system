...
@section('title', 'Reply to Contact Message')
        ...
        <div class="row">
            <div class="col-lg-8 mx-auto">
                <div class="card shadow-sm border-primary">
                    ...
                    <div class="card-body">
                        <!-- Reply Form -->
                        <form action="{{ route('dashboard.admin.contacts.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="reply_message" name="reply_message" class="form-control" rows="5">{{ old('reply_message') }}</textarea>
                                @error('reply_message')
