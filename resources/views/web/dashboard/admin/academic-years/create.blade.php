      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <!-- Form to create new academic year -->
              <form action="{{ route('dashboard.admin.academic-years.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                  ...
                  <select name="semester" id="semester" class="form-control @error('semester') is-invalid @enderror" required>
                    ...
                    <option value="Term 1" {{ old('semester') == 'Term 1' ? 'selected' : '' }}>Term 1</option>
                    <option value="Term 2" {{ old('semester') == 'Term 2' ? 'selected' : '' }}>Term 2</option>
                  </select>
                  @error('semester')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
